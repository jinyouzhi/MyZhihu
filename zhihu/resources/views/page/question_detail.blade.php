<div ng-controller="QuestionDetailController" class="container questoin-detail">
    <div class="card">
        ...
        <div class="hr"></div>
        <div class="feed item">
            <div ng-repeat="(key, item) in Question.current_question.answers_with_user_info" class="feed item clearfix">
                ...
                <div class="feed-item-content">
                    ...
                    <div class="action-set gray">
                        <span  ng-if="item.user_id == his.id">
                            {{--<a class="comment">评论</a>--}}
                            <a ng-click="Answer.answer_form = item">编辑</a>
                            <a ng-click="Answer.delete(item.id)">删除</a>
                        </span>
        ...
        {{--[: Answer.answer_form :]--}}
        <form name="answer_form" class="answer_form" ng-submit="Answer.add_or_update(Question.current_question.id)">
